let defaultOptions = {
  ...
  Dics = function (t) {
    (this.options = utils.extend({}, [defaultOptions, t], { clearEmpty: !0 })),
...
(Dics.prototype._load = function (t, i = 1e5) {
  t.naturalWidth
    ? (this._buidAfterFirstImageLoad(t),
      window.addEventListener("resize", () => {
        this._setContainerWidth(t), this._resetSizes();
      }))
    : i > 0
    ? (i--,
      setTimeout(() => {
  ...
  (Dics.prototype._buidAfterFirstImageLoad = function (t) {
    this._setContainerWidth(t), this._build(), this._setEvents();
  }),
  ...
  (Dics.prototype._resetSizes = function () {
    ...
    for (let t = 0; t < e.length; t++) {
      ...
      (s.style.flex = `0 0 ${i}px`),
        (s.querySelector(".b-dics__image").style[
  ...
  (Dics.prototype._setEvents = function () {
    let t = this;
    t._disableImageDrag(), (t._isGoingRight = null);
    let i = 0,
      e = function (e) {
  ...
  (Dics.prototype._applyGlobalClass = function (t) {
    ...
    t.hideTexts && i.classList.add("b-dics--hide-texts"),
      ...
      "center" === t.textPosition
        ? i.classList.add("b-dics--tp-center")
        : "bottom" === t.textPosition
        ? i.classList.add("b-dics--tp-bottom")
        : "left" === t.textPosition
        ? i.classList.add("b-dics--tp-left")
        : "right" === t.textPosition && i.classList.add("b-dics--tp-right");
  }),
  (Dics.prototype._createSlider = function (t, i) {
    let e = this._createElement("div", "b-dics__slider");
    return (
      this.options.linesColor && (e.style.color = this.options.linesColor),
  ...
  (Dics.prototype._createAltText = function (t, i, e) {
    ...
    if (s) {
      ...
      this.options.arrayBackgroundColorText &&
        (t.style.backgroundColor = this.options.arrayBackgroundColorText[i]),
        this.options.arrayColorText &&
          (t.style.color = this.options.arrayColorText[i]),
  ...
  (Dics.prototype._calcPosition = function (t) {
    let i = this.container.getBoundingClientRect(),
      e = isNaN(t[this.config.clientField])
        ? t.touches[0][this.config.clientField]
        : t[this.config.clientField];
    return i[this.config.positionField] < e
      ? e - i[this.config.positionField]
      : 0;
  }),
  (Dics.prototype._pushSections = function (t, i) {
    ...
    let e = this.sections[this._activeSlider],
      ...
      o =
        s.getBoundingClientRect()[this.config.sizeField] -
        (t -
  ...
  (Dics.prototype._setFlex = function (t, i) {
    ...
    for (let s = 0; s < this.sections.length; s++) {
      ...
      (e += n),
        (i && t > e - n && s > this._activeSlider) ||
        (!i && t < e && s < this._activeSlider)
          ? (o.style.flex = `1 100 ${n}px`)
          : (o.style.flex = `0 0 ${n}px`);
    }
  });
let utils = {
  extend: function (t, i, e) {
    for (let e in i) i.hasOwnProperty(e) && s(t, i[e]);
    function s(t, i) {
      for (let o in i)
        if (i.hasOwnProperty(o)) {
          ...
          if ("Object" === utils.getConstructor(n))
            ...
            if (e.clearEmpty && null == n) continue;
            t[o] = n;
          }
        }
    }
  ...
  setMultiEvents: function (t, i, e) {
    for (let s = 0; s < i.length; s++) t.addEventListener(i[s], e);
  },
  removeMultiEvents: function (t, i, e) {
    for (let s = 0; s < i.length; s++) t.removeEventListener(i[s], e, !1);
  },
